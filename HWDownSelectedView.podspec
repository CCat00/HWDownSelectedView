#
#  Be sure to run `pod spec lint HWDownSelectedView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "韩威" => "hw1627@163.com" }
  # Or just: s.author    = "韩威"
  # s.authors            = { "韩威" => "hw1627@163.com" }
  # s.social_media_url   = "http://twitter.com/韩威"
